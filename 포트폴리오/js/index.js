window.addEventListener('DOMContentLoaded', function () {
    window.scrollTo(0, 0);
    var chart = document.querySelector('.color_chart1');
    ...
    console.log(main.offsetTop) //메인에서 다운을 하면 내려가고
    var about_loc = 0;
    ...
    about.addEventListener('mousewheel', function (e) {
        ...
        } else if (e.wheelDelta < 0 && about.scrollTop > 1250) {
            window.scrollTo({
                top: work.offsetTop,
                left: 0,
                behavior: 'smooth'
    ...
    //질문할것 : scroll.y는 이해가 가지만 y2는 어떤원리인가
    // move란 정확히 무었인가요
    //state는 현 상태를 나타내는 지표같은 표시입니까?
